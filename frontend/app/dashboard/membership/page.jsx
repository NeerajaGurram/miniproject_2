...
import { Users, Upload, Calendar, Check, Ban, Award, FileIcon, X } from 'lucide-react';
...
export default function MembershipPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.member.trim()) newErrors.member = "Membership title is required";
    if (!formData.body.trim()) newErrors.body = "Body name is required";
    if (!formData.date2) newErrors.date2 = "Appointment date is required";
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      submissionData.append('member', formData.member);
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to submit Membership details');
      }
  ...
  const handleStatusChange = async () => {
    try {
      // console.log('slected',selectedMembership._id)
    ...
    <div className="flex justify-center p-4">
      ...
      >
        <div className="bg-gradient-brand p-6 text-center">
          ...
          <p className="text-brand-cream text-sm">Submit your membership details</p>
        </div>
        ...
        <div className="space-y-6 p-6">
          ...
          <div>
            <label className="block text-sm font-medium text-brand-primary mb-2">
              Body Name <span className="text-red-500">*</span>
            </label>
            <div className="relative">
              <input
                type="text"
